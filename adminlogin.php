...
<body>
    ...
    <div class="container justify-content-center align-item-center d-flex">
        <div class="row  mt-4 loginform justify-content-center">
            <div style="width:100%">
                <h5><b>Welcome Back, Please Login To Access Admin Dashboard</b></h5>
                <form class="mt-4" action="backend/admin/adminlogin.php" method="post">
                    ...
                    <?php endif; ?>
                    <a href="register.php">Not have an account? Register.</a> <br>
